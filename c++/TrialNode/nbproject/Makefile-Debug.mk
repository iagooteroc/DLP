...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trialnode

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trialnode: ${OBJECTFILES}
...
${OBJECTDIR}/Abb_functions.o: Abb_functions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abb_functions.o Abb_functions.cpp
